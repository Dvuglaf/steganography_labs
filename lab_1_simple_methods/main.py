...
# Стеганографическое НЗБ-встраивание с данными из задания 1-2
...
def extra_task_3(image, watermark_1, watermark_2):
    ...
    plot("Допзадание 1_1", image, marked_image, watermark_2, extracted_watermark_2, cb, marked_cb, "Cb")
    plot("Допзадание 1_2", image, marked_image, watermark_1, extracted_watermark, green, marked_green, "Зеленый")
...
# СВИ-2 на основании данных из задания 1-2
